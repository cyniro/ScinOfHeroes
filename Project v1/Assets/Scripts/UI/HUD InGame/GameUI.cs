...
public class GameUI : Singleton<GameUI>
{
    ...
    /// <summary>
    /// This will active agent to construct towers
    /// </summary>
    public bool activePeones;

    /// <summary>
    /// instruction to spawn Peones team
    /// </summary>
    public SpawnInstruction peonesSpawnInstruction;

    /// <summary>
    /// Team taht will build the tower
    /// </summary>
    Peons callPeones;
    ...
    public void SellSelectedTower()
    {
        ...
        if (PlayerStats.Instance != null && sellValue > 0)
        {
            PlayerStats.Instance.ChangeGold(sellValue);
    ...
    public bool IsValidPurchase()
    {
        ...
        return PlayerStats.Instance.CanAfford(m_CurrentTower.controller.purchaseCost);
    }
    ...
    void SpawnPeonesTeam()
    {
        //if (peonesSpawnInstruction == null)
        //{
        //    Debug.LogWarning("No spawnInstruction for Peonès");
        //    return;
        //}
        //AgentConfiguration agentConfig = peonesSpawnInstruction.agentConfiguration;
        //Node node = peonesSpawnInstruction.startingNode;
        ...
        //var agentInstance = poolable.GetComponent<PeonAgent>();

        //if (agentInstance == null)
        //{
        //    Debug.LogWarning("agentInstance = null");
        //    return;
        //}

        //Tower controller = m_CurrentTower.controller;
        //Vector3 destination = m_CurrentArea.GridToWorld(m_GridPosition, m_CurrentTower.controller.dimensions);

        //agentInstance.transform.position = spawnPosition;
        //agentInstance.Initialize();
        //agentInstance.SetDestination(destination);
        //agentInstance.transform.rotation = node.transform.rotation;
        //agentInstance.ThisJobIsForMe(controller, m_CurrentArea, m_GridPosition);
    }
}
