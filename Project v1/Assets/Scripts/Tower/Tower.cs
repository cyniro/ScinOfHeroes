...
public class Tower : Targetable, IDamageable
{
    /// <summary>
    ...
    /// <summary>
    /// allow tower to fire at start or no
    /// </summary>
    public bool disableAffectorsOnStart;
    ...
    public virtual void Initialize(IPlacementArea targetArea, IntVector2 destination)
    {
        ...
        SetLevel(0);
        //if we want to add a gameState
        //if (GameManager2.instanceExists)
        //{
        //    GameManager2.Instance.gameStateChanged += OnGameStateChanged;
        //}
    }
    ...
    public int GetSellLevel(int level)
    {
        ...
        //if (GameManager2.Instance.gameState == gameState.Building)
        //{
        //    int cost = 0;
    ...
    protected virtual void OnDestroy()
    {
        ...
        //{
        //    GameManager.Instance.levelStateChanged -= OnLevelStateChanged;
        //}
    }
    ...
    protected void SetLevel(int level)
    {
        ...
        if (disableAffectorsOnStart)
        {
            // can add a enum gamestatz to gamemanager and check if the game is started to set initialise
            initialise = false;
        }
        else
        {
