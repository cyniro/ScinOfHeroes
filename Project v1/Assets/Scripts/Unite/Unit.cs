...
public abstract class Unit : UnitEffect
{
    ...
    /// <summary>
    ////////////////////////////// A DELETER QUAND T4AURA GERER LE AGENT SELECTOR + POOL
    /// </summary>
    public UnitData unitData;
    public bool isInCD;
    public Sprite icon;
    public float cDBetweenSpawns = 60;
    public int cost;
    ...
    {
        get { return navMeshAgent.remainingDistance <= navMeshAgent.stoppingDistance; }
    }
    ...
    /// <summary>
    /// Moves the agent to a position in the <see cref="Unit.m_CurrentNode" />
    /// </summary>
    ...
    /// <summary>
    /// Move along the path, change to <see cref="Unit.State.OnPartialPath" />
    /// </summary>
